...
<body class="flex flex-col bg-gray-300 w-screen h-screen font-sans overflow-x-hidden">
    ...
    <!-- Formulario -->
        ...
        <form class="flex flex-row mx-auto justify-center content-center h-screen" action="SvHabitaciones" method="POST">
            <div class="flex flex-col mt-4 mb-4 gap-x-4 gap-y-2 bg-white p-4 rounded-3xl shadow-2xl">
                <p>Piso <select name="pisoHabitacion" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required>
                    <option>-</option>
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
                ...
                <p>Nº de Habitación<input name="numeroHabitacion" type="text" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required></p>
                <p>Nombre de habitación<input name="nombreHabitacion" type="text" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required></p>
                <p>Tipo de Habitación<select name="tipoHabitacion" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required>
                    <option>-</option>
                ...
                <p>Precio por noche<input name="precioHabitacion" type="text" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required></p>
