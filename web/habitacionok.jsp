...
<html lang="es">
    ...
    <body class="flex flex-col bg-gray-300 w-screen h-screen font-sans overflow-x-hidden">
        ...
        <div class="pointer-events-none flex flex-row mx-auto justify-center content-center h-screen">
            <div class="grid grid-cols-1 divide-y-4 divide-gray-400 items-center mt-4 mb-4 gap-x-4 gap-y-2 bg-white p-4 rounded-3xl shadow-2xl">
                <p class="font-bold text-lg text-green-700 mx-auto">¡Registro satisfactorio!</p>
                <p class="font-bold text-lg">Piso</br><label class="font-bold text-blue-600"><%=session.getAttribute("pisoHabitacion")%></label></p>
                <p class="font-bold text-lg">Nº de Habitación</br><label class="font-bold text-blue-600"><%=session.getAttribute("numeroHabitacion")%></label></p>
                <p class="font-bold text-lg">Nombre de habitación</br><label class="font-bold text-blue-600"><%=session.getAttribute("nombreHabitacion")%></label></p>
                <p class="font-bold text-lg">Tipo de habitación</br><label class="font-bold text-blue-600"><%=session.getAttribute("tipoHabitacion")%></label></p>
                <p class="font-bold text-lg">Precio por noche</br><label class="font-bold text-blue-600"><%=session.getAttribute("precioHabitacion")%></label></p>
            </div>
        </div>
        <!-- Pop-up -->
        <!-- Footer -->
