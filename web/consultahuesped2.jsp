...
<html lang="es">
    ...
    <body class="flex flex-col bg-gray-300 font-sans overflow-x-hidden">
        <%
            ...
            String dniConsulta = (String) misesion.getAttribute("dniConsulta");
            Date desde = (Date) misesion.getAttribute("desdeFormat");
            Date hasta = (Date) misesion.getAttribute("hastaFormat");
            SimpleDateFormat formateo = new SimpleDateFormat("dd-MM-yyyy");
            String desdeJSP = formateo.format(desde);
            String hastaJSP = formateo.format(hasta);
        %>
        <!-- Header -->
        <nav>
        ...
        <div class="flex items-start pt-2 justify-center min-h-screen bg-gray-800">
                <table class="table text-gray-100 border-separate space-y-6 text-sm p-3">
                ...
                <tbody>
                    <%
                      List <Reserva> listaReservas = (List) request.getSession().getAttribute("listaDesdeHasta");
            
                   for (Reserva res : listaReservas) {
                        Huesped hues = res.getHuesped();
                        String dni = Integer.toString(hues.getDni());
                        Date desdeRes = res.getCheck_in();
                        Date hastaRes = res.getCheck_out();
                       if (dniConsulta.equals(dni) && desde.before(desdeRes) || desde.equals(desdeRes) && hasta.after(hastaRes) || hasta.equals(hastaRes)){
                           ...
                           int documento = hues.getDni();
                           String nombreCompleto = nombre + " " + apellido;
                           Habitacion hab = res.getHabitacion();
                           int num = hab.getNum_habitacion();
                           String nombreHab = hab.getNombre_habitacion();
                    ...
                    <tr class="bg-gray-900">
                        ...
                        <td class="p-3 text-center"><%=usuario%></td>
                        <td class="p-3 text-center" >
                            <div class="flex">
