            ...
            <table class="table text-gray-100 border-separate space-y-6 text-sm">
                <thead class="bg-gray-900 text-gray-400">
                    <tr>
                        ...
                        <th class="p-3 text-center">Número</th>
                        <th class="p-3 text-center">Nombre</th>
                        <th class="p-3 text-center">Tipo</th>
                        <th class="p-3 text-center">Precio noche</th>
                    ...
                    <%
                        ...
                        for (Habitacion hab : listaHabitaciones) {
                               ...
                               int piso = hab.getPiso_habitacion();
                                ...
                                long idHabitacion = hab.getId_habitacion();
                                String precioF = "$ "+ precio;
                            
                    %>
                    <tr class="bg-gray-900">
                        <td class="p-3 text-center">
                            <div class="ml-3">
                                <div class="text-gray-400"><%=piso%></div>
                            </div>
                        </td>
                        <td class="p-3 text-center">
                            <%=num%>
                        ...
                        <td class="p-3 text-center" >
                            <div class="flex">
                                <form class="text-gray-400 hover:text-yellow-500 ml-2" method="POST" action="SvModificarHabitacion">
