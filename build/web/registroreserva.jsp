...
<body class="flex flex-col bg-gray-300 w-screen h-screen font-sans overflow-x-hidden">
    ...
    <div class="flex justify-center mt-2 mb-2">
        <p class="px-2 text-center text-xl border-b-2 border-gray-600 text-gray-900">Registro de huéspedes</p> 
    </div>

        <form class="flex flex-row mx-auto justify-center items-center h-screen" action="SvReserva" method="post">
            <div class="grid grid-cols-2 gap-x-4 gap-y-2 bg-white p-4 rounded-3xl shadow-2xl">
                <p>Cantidad de Personas<select name="cantidadHuesped" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required>
                    <option>-</option>
                ...
                <p>Nº de Habitación
                    <select name="numeroHabitacion" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required>
                    <option>-</option>
                        <%
        ...
        %>
                ...
                <p>Check-in<input name="check_in" type="date" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required></p>
                <p>Check-out<input name="check_out" type="date" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required></p>
                <p>DNI<input name="dni" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" type="text" required></p>
                <p>Nombre <input name="nombre" type="text" class= "border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required></p>
                <p>Apellido <input name="apellido" type="text" class= "border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required></p>
                <p>Fecha de Nacimiento <input name="nacimiento" type="date" class="mx-auto border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required></p>
                <p>Dirección <input name="direccion" type="text" class= "border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required></p>
                <p>Profesión <input name="profesion" type="text" class= "border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required></p>
                <p>Alta hecha por<input value="<%=usu%>" name="usuario" type="text" class= "pointer-events-none border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500"></p>
                <div class="col-span-2 mx-auto">
                    <button type="submit"class="w-48 hover:text-white font-bold bg-gray-400 text-gray-900 mt-2 px-2 rounded-3xl border-black hover:bg-green-500 transition duration-400">Enviar</button>
                </div>
            </div>
        </form>
