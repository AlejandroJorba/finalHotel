...
<body class="grid grid-rows-4 bg-gray-300 font-sans overflow-x-hidden">
    ...
    <div class="grid grid-cols-4 gap-4 mx-auto">
        <form action="SvConsultaReservas" method="get">
        <button class="transform hover:scale-110 transition duration-700 text-white bg-gray-800 h-20 lg:w-64 rounded-3xl shadow-xl">
            <p>Reservas</p>
        </button>
        </form>
