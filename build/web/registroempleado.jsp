...
<body class="flex flex-col bg-gray-300 w-screen h-screen font-sans overflow-x-hidden">
    ...
    <form class="flex flex-row mx-auto justify-center items-center h-screen" action="SvEmpleado" method="POST">
            <div class="grid grid-cols-2 gap-x-4 gap-y-4 bg-white p-4 rounded-3xl shadow-2xl">
                <p>DNI<input name="dni" type="text" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" type="text" required></p>
                ...
                <p>Cargo<select name="cargo" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required>
                    <option>-</option>
                    <option>Mozos</option>
                ...
                <p>Usuario<input name="user" type="text" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required></p>
                <p>Contraseña<input name="password" type="password" class="border-2 rounded border-gray-400 w-full focus:outline-none focus:border-green-500 focus:ring ring-green-500" required></p>
