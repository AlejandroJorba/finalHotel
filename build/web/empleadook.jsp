...
<body class="flex flex-col bg-gray-300 w-screen h-screen font-sans overflow-x-hidden">
    ...
    <div class="pointer-events-none flex flex-row mx-auto items-center h-screen">
            ...
            <div class="grid grid-cols-2 divide-y-4 divide-gray-400 items-center mt-4 mb-4 gap-x-4 gap-y-2 bg-white p-4 rounded-3xl shadow-2xl">
                ...
                <p class="font-bold border-t-2 text-lg">DNI</br><label class="font-bold text-blue-600"><%=session.getAttribute("dni")%></label></p>
                ...
                <p class="font-bold text-lg">Cargo</br><label class="font-bold text-blue-600"><%=session.getAttribute("cargo")%></label></p>
                <p class="font-bold text-lg">Usuario</br><label class="font-bold text-blue-600"><%=session.getAttribute("usu")%></label></p>
                <p class="font-bold text-lg">Contraseña</br><label class="font-bold text-blue-600"><%=session.getAttribute("contra")%></label></p>
