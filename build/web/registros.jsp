...
<head>
    ...
    %>
<body class="grid grid-rows-4 bg-gray-300 font-sans overflow-x-hidden">
    <!-- Header -->
    <nav>
    ...
    <div class="flex justify-center bg-gray-900 h-10 w-screen">
        <li class="flex self-center space-x-8 text-gray-400">
            ...
            <a class="border-b-2 border-green-300 text-green-300 hover:text-green-300" href="registros.jsp">Registros</a>
            <a class="hover:text-green-300" href="consultas.jsp">Consultas</a>
        </li>
    </div>
    <!-- Tarjetas rojas -->
    <div class="flex flex-row gap-8 mx-auto my-auto md:gap-24 lg:gap-24">
        <a href="registroreserva.jsp"><button class="transform hover:scale-110 transition duration-700 bg-gray-800 p-4 md:p-10 lg:p-10 text-white rounded-3xl shadow-xl">
            <p>Registro de reservas</p>
        </button></a>
        <a href="registroempleado.jsp"><button class="transform hover:scale-110 transition duration-700 bg-gray-800 text-white p-4 md:p-10 lg:p-10 rounded-3xl shadow-xl">
            <p>Registro de empleados</p>
        </button></a>
        <a href="registrohabitacion.jsp"><button class="transform hover:scale-110 transition duration-700 bg-gray-800 text-white p-4 md:p-10 lg:p-10 rounded-3xl shadow-xl">
            <p>Registro de habitaciones</p>
        </button></a>
    </div>
        <!-- Footer -->
        <div class="bg-gray-700 h-12 bottom-0 fixed w-screen flex justify-center items-center">
