    ...
    <body class="flex flex-col bg-gray-300 font-sans overflow-x-hidden">
        ...
        <div class="flex items-start pt-10 justify-center min-h-screen bg-gray-800">
            <table class="table text-gray-100 border-separate space-y-6 text-sm">
                ...
                <tbody>
                                    <%
                    List<Usuario> listaEmpleados = (List) request.getSession().getAttribute("listaEmpleados");
                    for (Usuario u : listaEmpleados) {
                        String nombreUsuario = u.getUsuario();
                        Empleado empl = u.getUsuarioEmpleado();
                        String nombreEmpleado = empl.getNombre();
                        String apellido = empl.getApellido();
                        int dni = empl.getDni();
                        String cargo = empl.getCargo();
                        String direccion = empl.getDireccion();
                        Date nacimiento = empl.getNacimiento();
                        long id_empleado = empl.getId_empleado();
                        long id_usuario = u.getId_usuario();
                        String nombreComp = nombreEmpleado + " " + apellido;
                ...
                %>
                    <tr class="bg-gray-900">
                        ...
                        <td class="p-3 text-center" >
                            <div class="flex">
                            <form class="text-gray-400 hover:text-yellow-500 ml-2" method="POST" action="SvModificarEmpleado">
